...
router.get("/getVerifiedNGOCount",adminVerification,adminController.getCountOfVerifiedNGO);
router.get("/getCompletedDrives",adminVerification,adminController.getNumberOfCompleteDrives);
router.get("/getAcceptedDonations",adminVerification,adminController.getDonationStat);
router.get("/getDonationReqTimeSeries",adminController.getDonationReqTimeSeries);router.get("/getNgoStates", adminVerification, adminController.getNgoStates);
