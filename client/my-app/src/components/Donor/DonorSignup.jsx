			...
			<form onSubmit={handleSubmit}>
				<div className={styles.signup_form}>
					<div className={styles.row}>
						<div className={styles.signup_text}>Full Name:<span style={{color:'red' }}>*</span> </div>
						<div className={styles.signup_input_element}>
							<input type='text'name='donor_name' className={styles.signup_input} value={formValues.donor_name} onChange={handleChange}/>
						</div>
					</div>
					<div className={styles.row}>
					...
					<div className={styles.row}>
						<div className={styles.signup_text}>Phone Number:<span style={{color:'red' }}>*</span></div>
						<div className={styles.signup_input_element}>
							<input type='text' name='phone' className={styles.signup_input} value={formValues.phone} onChange={handleChange}/>
						</div>	
					</div>
					<div className={styles.row}>
						<div className={styles.signup_text}>Alternative Phone Number: </div>
						<div className={styles.signup_input_element}>
							<input type='text' name='alt_phone' className={styles.signup_input} value={formValues.alt_phone} onChange={handleChange}/>
						</div>	
					</div>
					<div className={styles.row}>
						<div className={styles.signup_text}>Email:<span style={{color:'red' }}>*</span> </div>
						<div className={styles.signup_input_element}>
					...
					<div className={styles.row}>
						<div className={styles.signup_text}>Create Password (Minimum 8 characters):<span style={{color:'red' }}>*</span> </div>
						<div className={styles.signup_input_element}>
							<input type='Password' name='password' className={styles.signup_input} value={formValues.password} onChange={handleChange}/>
						</div>	
					</div>
                    <div className={styles.row}>
						<div className={styles.signup_text}>Re-enter Password:<span style={{color:'red' }}>*</span> </div>
						<div className={styles.signup_input_element}>
							<input type='Password' name='chk_password' className={styles.signup_input} value={formValues.chk_password} onChange={handleChange}/>
						</div>	
					</div>
					<div className={styles.row}>
					...
					<div className={styles.row}>
						<div className={styles.signup_text}>City: <span style={{color:'red' }}>*</span></div>
						<div className={styles.signup_input_element}>
					...
					<div className={styles.row}>
						<div className={styles.signup_text}>Nationality:<span style={{color:'red' }}>*</span> </div>
						<div className={styles.signup_input_element}>
							<select name='nationality' className={styles.signup_select} value={formValues.nationality} onChange={handleChange} defaultValue="">
